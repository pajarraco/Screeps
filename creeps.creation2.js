var createCreep = function(name, role, creeps) {
  ...
  Game.spawns['Spawn2'].createCreep([WORK, CARRY, MOVE], undefined, {role: role, source: n});
};
          ...
          if (builders.length < 2) {
            ...
            /*  var deliveries =
              ...
              if (deliveries.length < 2) {
                ...
                var newName = Game.spawns['Spawn2'].createCreep([CARRY, MOVE], undefined, {role: 'delivery', source:
              n});
              } else {*/
            //
            // Mechanic
            ...
            if (mechanics.length < 2) {
              ...
              // Explorer
              /*  var explorers =
                    _.filter(Game.creeps, (creep) => creep.memory.role == 'explorer' && creep.room.name ==
                'E37S67');

    ...
    if (harvesters.length < 1) {
      ...
      if (miners.length < 2) {
        ...
        if (upgraders.length < 3) {
          ...
          //
          // Tower keeper
          const towerkeepers = _.filter(Game.creeps, (creep) => creep.memory.role == 'towerkeeper' && creep.room.name == spawn.room.name);
          if (towerkeepers.length < 1) {
            ...
            if (builders.length < 1) {
              ...
              //
              // Harvester
              const harvestersmine = _.filter(Game.creeps, (creep) => creep.memory.role == 'harvestermine' && creep.room.name == spawn.room.name);
              if (harvestersmine.length < 0 && (spawn.room.name === home1 || spawn.room.name === home2)) {
              ...
              if (conquesters.length < 1 && spawn.room.name === home1) {
              ...
              if (explorerminers.length < 2 && spawn.room.name === home1) {
